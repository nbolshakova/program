...
// kaskad.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CkaskadApp, CWinApp)
...
// Единственный объект CkaskadApp

CkaskadApp theApp;


// инициализация CkaskadApp

BOOL CkaskadApp::InitInstance()
{
